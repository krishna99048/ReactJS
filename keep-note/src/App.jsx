  ...
  return (
    <>
      <section className='lg:flex items-center justify-center'>
        ...
        <div className='lg:w-1/2 w-full h-screen lg:border-l-4 gap-6 max-lg:border-t-2 border-dashed border-black bg-gray-200 flex flex-wrap items-center justify-center p-6 overflow-auto'>
          {Tasks.map((task,id) => {
            return (
              <div className='w-full max-w-78 h-78 bg-white rounded-4xl shadow-2xl flex items-end justify-center p-4 relative' key={id}>


                <img src="./pin.png" alt="" className='w-15 h-auto absolute z-10 top-2' />


                <div className='w-full h-60 bg-orange-200 rounded-4xl'>
                  <h1 className='text-5xl fomnt-bold flex items-center justify-center'>{id + 1}</h1>
